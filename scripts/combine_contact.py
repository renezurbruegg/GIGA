...
folder = "/itet-stor/zrene/net_scratch/dataset_new/pile_w_contact/"
ds = glob.glob(os.path.join(folder, "*/grasps_candidate.csv"))
out = os.path.join(folder, "../GIGA_pile_w_contact")
...
all_dfs.to_csv(os.path.join(out, "grasps_candidate.csv"), index=False)
# print(all_dfs)